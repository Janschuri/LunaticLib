...
public class VelocityCommand implements SimpleCommand {
    ...
    public void execute(final Invocation invocation) {
        ...
        proxyServer.getScheduler().buildTask(pluginInstance, () -> {
            Sender commandSender = VelocitySenderHandler.getAdapter().getSender(sender);
    ...
    public CompletableFuture<List<String>> suggestAsync(final Invocation invocation) {
        ...
        return CompletableFuture.completedFuture(lunaticCommand.tabComplete(VelocitySenderHandler.getAdapter().getSender(source), newArgs));
    }
}