package de.janschuri.lunaticlib.commands.platform.velocity;
...
import de.janschuri.lunaticlib.commands.platform.velocity.impl.PlatformImpl;
...
public final class VelocityLunaticLibCommands extends LunaticLibCommands {

    private static PlatformImpl platform;
    private static ProxyServer proxy;
    private static PluginContainer instance;

    public static void enable(ProxyServer proxy, PluginContainer instance) {
        if (platform == null) {
