/*
 * This MetricsBungeecoord class was auto-generated and can be copied into your project if you are
...
public class MetricsBungeecoord {
  ...
  /**
   * Creates a new MetricsBungeecoord instance.
   *
   * @param plugin Your plugin instance.
   * @param serviceId The id of the service. It can be found at <a
   *     href="https://bstats.org/what-is-my-plugin-id">What is my plugin id?</a>
   */
  public MetricsBungeecoord(Plugin plugin, int serviceId) {
    this.plugin = plugin;
    try {
      loadConfig();
    } catch (IOException e) {
  ...
  public static class MetricsBase {
    ...
    /** The version of the MetricsBungeecoord class. */
    ...
    public MetricsBase(
      ...
      ScheduledThreadPoolExecutor scheduler =
          new ScheduledThreadPoolExecutor(1, task -> new Thread(task, "bStats-MetricsBungeecoord"));
    ...
    private void startSubmitting() {
      ...
      // WARNING: You must not modify and part of this MetricsBungeecoord class, including the
    ...
    private void sendData(JsonObjectBuilder.JsonObject data) throws Exception {
      ...
      connection.setRequestProperty("User-Agent", "MetricsBungeecoord-Service/1");
    ...
    private void checkRelocation() {
      ...
      if (System.getProperty("bstats.relocatecheck") == null
        ...
        if (MetricsBase.class.getPackage().getName().startsWith(defaultPackage)
          ...
          throw new IllegalStateException("bStats MetricsBungeecoord class has not been relocated correctly!");
        }
      }
    }
