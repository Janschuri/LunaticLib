/*
 * This MetricsBukkit class was auto-generated and can be copied into your project if you are
...
public class MetricsBukkit {
  ...
  /**
   * Creates a new MetricsBukkit instance.
   *
  ...
  public static class MetricsBase {
    ...
    /** The version of the MetricsBukkit class. */
    ...
    public MetricsBase(
      ...
      ScheduledThreadPoolExecutor scheduler =
          new ScheduledThreadPoolExecutor(1, task -> new Thread(task, "bStats-MetricsBukkit"));
    ...
    private void startSubmitting() {
      ...
      // WARNING: You must not modify and part of this MetricsBukkit class, including the
    ...
    private void sendData(JsonObjectBuilder.JsonObject data) throws Exception {
      ...
      connection.setRequestProperty("User-Agent", "MetricsBukkit-Service/1");
    ...
    private void checkRelocation() {
      ...
      if (System.getProperty("bstats.relocatecheck") == null
        ...
        if (MetricsBase.class.getPackage().getName().startsWith(defaultPackage)
          ...
          throw new IllegalStateException("bStats MetricsBukkit class has not been relocated correctly!");
        }
      }
    }
