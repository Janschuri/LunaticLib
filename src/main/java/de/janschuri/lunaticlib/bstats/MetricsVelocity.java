/*
 * This MetricsVelocity class was auto-generated and can be copied into your project if you are
 ...
 */
package de.janschuri.lunaticlib.bstats;
...
public class MetricsVelocity {
  ...
  /** A factory to create new MetricsVelocity classes. */
  public static class Factory {
    ...
    /**
     * Creates a new MetricsVelocity class.
     *
     * @param plugin The plugin instance.
     * @param serviceId The id of the service. It can be found at <a
     *     href="https://bstats.org/what-is-my-plugin-id">What is my plugin id?</a>
     *     <p>Not to be confused with Velocity's {@link PluginDescription#getId()} method!
     * @return A MetricsVelocity instance that can be used to register custom charts.
  ...
  public static class MetricsBase {
    ...
    /** The version of the MetricsVelocity class. */
    ...
    public MetricsBase(
      ...
      ScheduledThreadPoolExecutor scheduler =
          new ScheduledThreadPoolExecutor(1, task -> new Thread(task, "bStats-MetricsVelocity"));
    ...
    private void startSubmitting() {
      ...
      // WARNING: You must not modify and part of this MetricsVelocity class, including the
    ...
    private void sendData(JsonObjectBuilder.JsonObject data) throws Exception {
      ...
      connection.setRequestProperty("User-Agent", "MetricsVelocity-Service/1");
    ...
    private void checkRelocation() {
      ...
      if (System.getProperty("bstats.relocatecheck") == null
        ...
        if (MetricsBase.class.getPackage().getName().startsWith(defaultPackage)
          ...
          throw new IllegalStateException("bStats MetricsVelocity class has not been relocated correctly!");
        }
      }
    }
