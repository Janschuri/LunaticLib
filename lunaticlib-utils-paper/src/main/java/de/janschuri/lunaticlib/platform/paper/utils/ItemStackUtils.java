...
public class ItemStackUtils {
    ...
    public static Map<String, Object> itemStackToMap(ItemStack itemStack) {
        ...
        if (itemStack.hasItemMeta()) {
            ...
            if (metaMap.get("meta-type") != null && metaMap.get("meta-type").equals("SKULL")) {
                SkullMeta skullMeta = (SkullMeta) meta;

                Map<String, Object> skullMap =  skullMeta.getPlayerProfile().serialize();
                skullMap.put("==", "PlayerProfile");
                metaMap.put("skull-owner", skullMap);
            }
        ...
        try {
            ...
            if (map.containsKey("meta")) {
                try {
                    ...
                    Object skullOwnerObj = metaMap.get("skull-owner");
                    ...
                    if (metaMap.get("meta-type") != null && metaMap.get("meta-type").equals("SKULL") && skullOwnerObj != null) {
                        try {
                            Map<String, Object> skullOwnerMap = (Map<String, Object>) skullOwnerObj;

                            Object profileObj = ConfigurationSerialization.deserializeObject(skullOwnerMap);
                            PlayerProfile profile = (PlayerProfile) profileObj;
                            SkullMeta skullMeta = (SkullMeta) meta;
                            skullMeta.setOwnerProfile(profile);
                            meta = skullMeta;
                        } catch (Exception e) {
                            UtilsLogger.error("Error setting skull owner: " + e.getMessage());
                        }
                    }
                    ...
                    UtilsLogger.error("Error: " + e.getMessage());
                }
            }
