package de.janschuri.lunaticlib.inventorygui.handler;
...
import de.janschuri.lunaticlib.inventorygui.interfaces.Reopenable;
...
public class GUIManager {
    ...
    public static void reopenGUI(@NotNull Reopenable reopenable, Player player) {
        ...
        if (reopenable == null) {
            UtilsLogger.error("Reopenable GUI not found for key: " + uniqueKey);
            return;
        }
    ...
    public static void openGUI(@NotNull InventoryHandler gui, Player player) {
        ...
        Bukkit.getScheduler().runTask(LunaticLibInventoryGui.getPluginInstance(), () -> {
